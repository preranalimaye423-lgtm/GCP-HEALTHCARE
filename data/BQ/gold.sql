...
CREATE TABLE IF NOT EXISTS `gold_dataset.provider_charge_summary` (
...
# truncate table
TRUNCATE TABLE `gold_dataset.provider_charge_summary`;

# insert data
INSERT INTO `gold_dataset.provider_charge_summary`
SELECT 
...
# CREATE TABLE
CREATE TABLE IF NOT EXISTS `gold_dataset.patient_history` (
    Patient_Key STRING,
    FirstName STRING,
    LastName STRING,
    Gender STRING,
...
# TRUNCATE TABLE
TRUNCATE TABLE `gold_dataset.patient_history`;

# INSERT DATA
INSERT INTO `gold_dataset.patient_history`
SELECT 
    p.Patient_Key,
    p.FirstName,
    p.LastName,
...
# CREATE TABLE
CREATE TABLE IF NOT EXISTS `gold_dataset.provider_performance` (
    ProviderID STRING,
    FirstName STRING,
    LastName STRING,
...
# TRUNCATE TABLE
TRUNCATE TABLE `gold_dataset.provider_performance`;

# INSERT DATA
INSERT INTO `gold_dataset.provider_performance`
SELECT 
    pr.ProviderID,
    pr.FirstName,
    pr.LastName,
...
FROM `silver_dataset.providers` pr
LEFT JOIN `silver_dataset.encounters` e 
...
# CREATE TABLE
CREATE TABLE IF NOT EXISTS `gold_dataset.department_performance` (
    Dept_Id STRING,
...
# TRUNCATE TABLE
TRUNCATE TABLE `gold_dataset.department_performance`;

# INSERT DATA
INSERT INTO `gold_dataset.department_performance`
SELECT 
    d.Dept_Id,
...
FROM `silver_dataset.departments` d
LEFT JOIN `silver_dataset.encounters` e 
